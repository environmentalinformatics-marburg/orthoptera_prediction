...
if(Sys.info()["sysname"] == "Windows"){
  filepath_base <- "F:/analysis/orthoptera/"
} else {
  filepath_base <- "/media/tnauss/myWork/analysis/orthoptera/"
}

filepath_data <- paste0(filepath_base, "data/")
filepath_landsat <- paste0(filepath_data, "landsat/")
filepath_obsv <- paste0(filepath_data, "orthoptera/")
filepath_results <- paste0(filepath_data, "rdata/")
